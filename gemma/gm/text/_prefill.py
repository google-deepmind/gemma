...
from kauldron.typing import Bool, Int, PRNGKey, UInt8, typechecked  # pylint: disable=g-multiple-import,g-importing-member
...
def prefill(
  ...
  # Wrap the last state into a wrapper to simplify the logic of adding the
  # previous turns to the prefill.
